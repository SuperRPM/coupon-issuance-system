...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/SuperRPM/coupon-issuance-system/gen/proto/coupon/v1"
	http "net/http"
	strings "strings"
)
...
func NewCouponServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) CouponServiceClient {
	...
	couponServiceMethods := v1.File_proto_coupon_v1_coupon_proto.Services().ByName("CouponService").Methods()
